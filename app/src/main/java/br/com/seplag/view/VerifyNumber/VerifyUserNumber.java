...
public class VerifyUserNumber extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_sendcode.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(VerifyUserNumber.this, "Aguarde, você receberá o código em alguns segundos...",
        ...
        bt_sendagain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(VerifyUserNumber.this, "Aguarde, estamos enviando um novo código...",
                        Toast.LENGTH_LONG).show();
            }
        });
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            if (!phone.equals(null)) {
                                ...
                                UserSessionHelper user_session = new UserSessionHelper(VerifyUserNumber.this);
                            ...
                            progressDialog.dismiss();
                            Toast.makeText(VerifyUserNumber.this, "Código errado, insira novamente ou solicite " +
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(VerifyUserNumber.this, LoginActivity.class));
    }
}
